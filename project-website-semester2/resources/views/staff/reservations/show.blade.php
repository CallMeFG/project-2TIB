        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100 space-y-6">
                    ...
                    <div>
                        <a href="{{ route('staff.reservations.index') }}" class="inline-flex items-center text-sm text-blue-600 dark:text-blue-400 hover:underline mb-6">
                    ...
                    {{-- Di halaman detail ini, Staff mungkin tidak perlu mengubah status secara langsung lagi --}}
                    {{-- karena sudah ada di halaman daftar. Tapi bisa ditambahkan jika perlu. --}}
